    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Azriel Maulana");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, "18");
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Azriel Maulana");
                mPerson.setAge(18);
                mPerson.setEmail("bancet6996@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "088222656489";
